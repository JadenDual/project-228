...
store_driving_data = []
car_names = {}
# DECLARE A car_names DICTIONARY HERE.
...
if 'name' in car_names:
    vehicles_nearby = car_names['name']
    driving_data['vehicle_name']=vehicles_nearby
store_driving_data.append(driving_data)


field_names = ['brake', 'hand_brake', 'throttle', 'steer', 'vehicle_name']
csv_file_store = open('car_names.csv', 'w', newline = '')
    ...
    def tick(self, world, clock):
        ...
        if len(vehicles) > 1:
            ...
            for d, vehicle in sorted(vehicles, key=lambda vehicles: vehicles[0]):
                ...
                car_names['name'] = vehicle_type
                # ADD CODE LINE HERE OF TASK1
